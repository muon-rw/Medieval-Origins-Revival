...
public class ModActions {
    ...
    public static final RegistryObject<CureVillagerAction> CURE_VILLAGER = BIENTITY_ACTIONS.register("cure_villager",
            () -> new CureVillagerAction(CureVillagerAction::cureVillager));
