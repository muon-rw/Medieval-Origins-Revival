...
public class ModifyPierceLevelPowerType extends ValueModifyingPowerType {
    private final Optional<EntityAction> selfAction;

    public ModifyPierceLevelPowerType(List<Modifier> modifiers, Optional<EntityCondition> condition, Optional<EntityAction> selfAction) {
    ...
    public @NotNull PowerConfiguration<?> getConfig() {
        return ModPowerTypes.MODIFY_PIERCE_LEVEL;
    }

    public static final PowerConfiguration<ModifyPierceLevelPowerType> FACTORY = PowerConfiguration.of(
            ...
            ValueModifyingPowerType.createConditionedModifyingRequiredDataFactory(
                    ...
                    (data, modifiers, entityCondition) -> new ModifyPierceLevelPowerType(
                            modifiers,
                            entityCondition,
